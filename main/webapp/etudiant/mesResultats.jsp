...
<%
    ...
    List<Resultat> liste = dao.listerResultatsParEmail(user.getEmail());
%>
    ...
    <div class="card shadow card-custom">
        ...
        <div class="card-body p-4">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted">
                    Historique de vos examens et notes
                </p>
...
<footer class="text-white py-4 mt-5">
    ...
    <div class="container text-center">
        ...
        <p class="mb-1">
            Plateforme moderne pour les examens en ligne
        </p>
...
new DataTable('#mesResultatsTable', {
    ...
    language: {
        ...
        lengthMenu:
        "Afficher _MENU_ résultats",

        info:
        "Affichage de _START_ à _END_ sur _TOTAL_ résultats",

        infoEmpty:
        "Aucun résultat disponible",

        infoFiltered:
        "(filtré de _MAX_ résultats)",
